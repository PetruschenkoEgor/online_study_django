...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.course = Course.objects.create(title='Курс тест', description='Тест', owner=self.user)
        self.lesson = Lesson.objects.create(title='Урок тест', description='Тест', link_to_the_video='http://youtube.com/test', course=self.course, owner=self.user)
...
class SubscriptionTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.course = Course.objects.create(title='Курс тест1', description='Тест1', owner=self.user)
