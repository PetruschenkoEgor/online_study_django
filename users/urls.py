...
from users.views import (PaymentsCreateAPIView, PaymentsListAPIView,
                         PaymentsRetrieveAPIView, UserCreateAPIView, UserRetrieveAPIView,
                         UserListAPIView, UserUpdateAPIView, UserDestroyAPIView, )
...
urlpatterns = [
    ...
    path('personal_account/<int:pk>/', UserRetrieveAPIView.as_view(), name='personal_account'),
